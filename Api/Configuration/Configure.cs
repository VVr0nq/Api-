        ...
        public static void ConfigureIdentity(this IServiceCollection services)
        {
            services
                ...
                .AddIdentity<UserEntity, UserRole>(options =>
                {
                    ...
                    options.Password.RequireNonAlphanumeric = true; options.Lockout.MaxFailedAccessAttempts = 3;
                })
...
SymmetricSecurityKey(Encoding.UTF8.GetBytes(jwtSettings.Secret)),
                    ...
                    options.Events = new JwtBearerEvents()
                    {
                        ...
                        OnChallenge = context =>
                        {
                            ...
                            context.Response.ContentType = "application/json"; var result = JsonConvert.SerializeObject("401 Not authorized");
                            return context.Response.WriteAsync(result);
                        },
                        OnForbidden = context =>
                        {
                            context.Response.StatusCode = 403;
                            context.Response.ContentType = "application/json"; var result = JsonConvert.SerializeObject("403 Not authorized");
                            return context.Response.WriteAsync(result);
                        },
                    };
                });
